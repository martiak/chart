...
(function(){
    ...
    *********************************************************************/
    if(youtube.length > 0){
        ...
        template_iframe.setAttribute('allow','autoplay;encrypted-media;clipboard-write;picture-in-picture');
        template_iframe.setAttribute('sandbox','allow-scripts allow-same-origin allow-presentation allow-popups');
        template_iframe.setAttribute('allowfullscreen','');
        template_iframe.setAttribute('referrerpolicy', 'no-referrer')
            ...
            elements.forEach(function(e){
                ...
                if(e.isIntersecting === true){
                    ...
                    this_playbtn.addEventListener('click',function(){
                        ...
                        this_iframe.src = 'https://www.youtube-nocookie.com/embed/' + this_data_id + (this_data_id.includes('?') ? '&' : '?') + 'autoplay=1';
